    ...
    <div class="currencies-modal">
        <div class="currencies-modal-card">
             <div class="currencies-modal-card-header">
                 ...
                 <h4>انتخاب بازار</h4>
                 <svg id="x-octagon" xmlns="http://www.w3.org/2000/svg" width="20.909" height="20.541" viewBox="0 0 28.909 28.541" class="close_modal">
                     <path id="Path_1851" data-name="Path 1851" d="M8.2.26A.909.909,0,0,1,8.841,0H20.068a.909.909,0,0,1,.638.26L28.645,8.1a.886.886,0,0,1,.264.63V19.813a.886.886,0,0,1-.264.63l-7.939,7.838a.909.909,0,0,1-.638.26H8.841a.909.909,0,0,1-.638-.26L.264,20.443A.886.886,0,0,1,0,19.813V8.728A.886.886,0,0,1,.264,8.1ZM9.215,1.784,1.807,9.1V19.444l7.408,7.314H19.694L27.1,19.444V9.1L19.694,1.784Z" fill="gray"/>
                     <path id="Path_1852" data-name="Path 1852" d="M4.682,4.678a.632.632,0,0,1,.882,0l3.3,3.227,3.3-3.227a.633.633,0,0,1,.882,0,.6.6,0,0,1,0,.863L9.74,8.767l3.3,3.226a.6.6,0,0,1,0,.863.633.633,0,0,1-.882,0l-3.3-3.227-3.3,3.227a.633.633,0,0,1-.882,0,.6.6,0,0,1,0-.863l3.3-3.226-3.3-3.226a.6.6,0,0,1,0-.863Z" transform="translate(5.595 5.503)" fill="gray"/>
                 </svg>
                 </div>
    ...
    <div class="transaction-confirm-modal">
        <div class="confirm-modal-card">
             <div class="transaction_details">
                 <img src="../assets/logo/currencies/GRADE_24_GOLD_GRAM-icon-64.png" alt="" id="confirm_currency_icon">
    ...
    <div class="side-menu">
        ...
        <div class="menu-options-container">
            <div class="menu-option-users " data-tab="users_tab">
                ...
                <div class="user_tabs ">
                    <a href="/platform.barayannd.ir/"><p class="tab">اطلاعات من </p></a>
                    <hr>
                    <a href="/platform.barayannd.ir/"><p class="tab"> عملکرد من </p></a>
                    <hr>
                ...
                <div class="transaction-inputs">
                   <div class="transaction-tabs">
                    ...
                    <div class="currencies-wrapper-preveiw">
                        <div class="currency">
                          <img src="../assets/logo/currencies/GRADE_24_GOLD_GRAM-icon-64.png" alt="" id="currency_img">
