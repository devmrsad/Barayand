...
for ($attempt = 0; $attempt < $maxRetries; $attempt++) {
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, "https://Api.BrsApi.ir/Market/Cryptocurrency.php?key=$apiKey");
...
for ($attempt = 0; $attempt < $maxRetries; $attempt++) {
    $ch2 = curl_init();
    curl_setopt($ch2, CURLOPT_URL, "https://Api.BrsApi.ir/Market/Gold_Currency.php?key=$apiKey");
